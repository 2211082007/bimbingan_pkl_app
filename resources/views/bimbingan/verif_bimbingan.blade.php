                        ...
                        <tbody>
                            @forelse ($data_belumVerif as $index => $laporan)
                                <tr>
                                    ...
                                    <td>
                                        @if ($laporan->laporan)
                                            <a href="{{ asset('storage/' . $laporan->laporan) }}" target="_blank">Lihat File</a>
                                        @else
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#setujuModal-{{ $laporan->id_bimbinganPkl }}">
                                            <i class="fas fa-check"></i> Setuju
                                        </button>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#tolakModal-{{ $laporan->id_bimbinganPkl }}">
                                ...
                                <!-- Modal Setuju -->
                                <div class="modal fade" id="setujuModal-{{ $laporan->id_bimbinganPkl }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('verif.bimbinganPkl', $laporan->id_bimbinganPkl) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                        ...
                        <tbody>
                            @forelse ($data_sudahVerif as $index => $laporan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('batal.verif', $laporan->id_bimbinganPkl) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
