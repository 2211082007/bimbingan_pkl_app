              ...
              <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  ...
                  <small class="text-muted">
                    @role('superAdmin') Super Admin @endrole
                    @role('admin') Admin @endrole
                    @role('mahasiswa') Mahasiswa @endrole
                    @role('mahasiswaPkl') Mahasiswa PKL @endrole
                    @role('kaprodi') Kaprodi @endrole
                    @role('pembimbingPkl') Pembimbing PKL @endrole
                    @role('pengujiPkl') Penguji PKL @endrole
                    @role('dosen') Dosen @endrole
                  </small>
                </div>
              </div>
            </a>
